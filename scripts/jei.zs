...
// JEI.hideItem(<item:immersiveengineering:armor_steel_head>);
// JEI.hideItem(<item:immersiveengineering:armor_steel_chest>);
// JEI.hideItem(<item:immersiveengineering:armor_steel_legs>);
// JEI.hideItem(<item:immersiveengineering:armor_steel_feet>);
// JEI.hideItem(<item:immersiveengineering:sword_steel>);
// JEI.hideItem(<item:immersiveengineering:pickaxe_steel>);
// JEI.hideItem(<item:immersiveengineering:axe_steel>);
// JEI.hideItem(<item:immersiveengineering:hoe_steel>);
// JEI.hideItem(<item:immersiveengineering:shovel_steel>);
