...
<tag:forge:colorant/pink>.addItems([<item:botania:pink_mushroom>, <item:botania:pink_petal>, <item:simplefarming:cactus_fruit>, <item:pamhc2crops:cactusfruititem>, <item:upgrade_aquatic:flowering_rush>, <item:biomesoplenty:pink_daffodil>, <item:biomesoplenty:pink_hibiscus>, <item:upgrade_aquatic:searocket_pink>, <item:buzzierbees:pink_clover>, <item:minecraft:pink_tulip>, <item:buzzierbees:pink_hibiscus>, <item:buzzierbees:cartwheel>, <item:minecraft:peony>, <item:minecraft:brain_coral>, <item:minecraft:brain_coral_fan>]);
<tag:forge:colorant/lime>.addItems([<item:botania:lime_mushroom>, <item:botania:lime_petal>]);
<tag:forge:colorant/yellow>.addItems([<item:botania:yellow_mushroom>, <item:botania:yellow_petal>, <item:minecraft:dandelion>, <item:biomesoplenty:goldenrod>, <item:buzzierbees:daybloom>, <item:minecraft:sunflower>, <item:minecraft:horn_coral>, <item:minecraft:horn_coral_fan>]);
