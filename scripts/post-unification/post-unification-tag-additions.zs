...
public function postUnificationTagAdditions() as void {
    ...
    <tag:forge:storage_blocks/quartz>.addItems([<item:botania:dark_quartz>, <item:botania:mana_quartz>, <item:botania:blaze_quartz>, <item:botania:lavender_quartz>, <item:botania:red_quartz>, <item:botania:elf_quartz>, <item:botania:sunny_quartz>]);
}