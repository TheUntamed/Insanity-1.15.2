...
Forge 1.15.2-31.2.33 --> 1.15.2-31.2.36
...
* *Cyclic* (0.6.1 --> 0.6.2)
* *Cyclops Core* (1.8.0 --> 1.8.3)
* *Danny's Ores* (1.2.0 --> 1.3.2)
* *Decorative Blocks* (6d --> 1.7)
* *Double Slabs* (2.9.0 --> 2.10.1)
* *Druidcraft* (0.4.21 --> 0.4.31)
* *Dungeon Crawl* (2.0.1 --> 2.0.2)
* *EnderChests* (1.6.1 --> 1.6.2)
* *EnderTanks* (1.8.1 --> 1.8.2)
...
* *Just Enough Items (JEI)* (6.0.2.12 --> 6.0.3.15)
...
* *Mystical Agriculture* (3.0.8 --> 3.0.10)
* *Mystical World* (2.0.6 --> 2.1.1)
* *Pam's HarvestCraft 2 - Trees* (1.0.5 --> 1.0.7)
* *Performant* (2.11m --> 3.10m)
...
* *Structurize* (0.10.313 --> 0.13.31)
* *TerraForged* (0.1.0 --> 0.1.1)
* *Tetra* (2.16.1 --> 2.18.1)
* *Tetraits* (0.0.2 --> 0.1.1)
* *The One Probe* (2.0.4 --> 2.0.7)
* *Torchmaster* (2.2.1 --> 2.2.2)
* *U Team Core* (3.0.1.164 --> 3.0.2.169)
* *Vanilla Things* (0.5.7 --> 0.6)
