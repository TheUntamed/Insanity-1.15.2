...
* *Camera Mod* (1.6.4 --> 1.6.8)
* *Carbonado* (2.0.3 --> 2.0.6)
* *Carpet Stairs Mod* (1.4.2 --> 1.4.4)
* *Cloth Config API (Forge)* (2.0 --> 3.0)
* *Controlling* (6.1.4 --> 6.1.4)
* *Cooking for Blockheads* (8.0.1 --> 8.0.2)
* *Corail Tombstone* (4.3.4 --> 4.3.8)
* *Corail Woodcutter* (1.1.2 --> 1.1.3)
* *CraftTweaker* (6.0.0.17 --> 6.0.0.24)
* *Cucumber Library* (3.0.5 --> 3.0.7)
* *Curios API* (2.0.2.2 --> 2.0.2.3)
* *Cyclic* (0.3.4 --> 0.4.1)
...
* *Engineer's Decor* (1.0.20-b5 --> -1.1.0-b1)
* *Essentials* (2.7.0 --> 2.7.2)
* *Extended Crafting* (2.0.0 --> 2.0.2)
* *Extra Tags* (1.0 --> 1.1)
...
* *Mekanism* (9.10.0.413 --> 9.10.7.420)
* *Mekanism Generators* (9.10.0.413 --> 9.10.7.420)
* *Mekanism Tools* (9.10.0.413 --> 9.10.7.420)
* *MixinBootstrap* (1.0.2 --> 1.0.3)
* *Modular Routers* (6.0.0-14 --> 6.1.0-17)
...
* *PlantTech 2* (0.02.04 --> 0.02.10)
* *Powah!* (1.1.12 --> 1.1.14)
* *Quark* (r2.1-231 --> r2.1-240)
* *Quickstack* (3.0.3c --> 3.0.3c)
* *ReAuth* (3.8.0 --> 3.8.1)
* *Refined Storage* (1.8.1 --> 1.8.4)
* *Reliquary v1.3* (1.3.4.972 --> 1.3.4.995)
* *RFTools Base* (1.0.1-alpha --> 1.1.1-beta)
* *RFTools Builder* (2.0.1-alpha --> 2.1.2-beta)
* *RFTools Power* (2.0.1-alpha --> 2.1.1-beta)
* *RFTools Storage* (1.0.3-alpha --> 1.1.3-beta)
* *RFTools Utility* (2.0.1-alpha --> 2.1.3-beta)
* *Ring of Attraction [FORGE]* (1.1.27 --> 1.1.33)
* *Ring of Blink [FORGE]* (1.1.22 --> 1.1.28)
* *Ring of Growth [FORGE]* (1.1.24 --> 1.1.30)
* *Ring of Repair [FORGE]* (1.1.24 --> 1.1.30)
* *Ring of Return [FORGE]* (1.0.6 --> 1.0.12)
* *Ring of Teleport [FORGE]* (1.1.23 --> 1.1.29)
* *Ring of the Enderchest [FORGE]* (1.1.25 --> 1.1.31)
...
* *Cucumber Library* (3.0.4 --> 3.0.5)
* *Cyclic* (0.3.0 --> 0.3.2)
* *Cyclops Core* (1.6.1 --> 1.6.2)
* *Dark Utilities* (3.0.2 --> 3.0.3)
* *Double Slabs* (2.1.1 --> 2.2.3)
* *EmbellishCraft* (2.1.0.0 --> 2.1.0.1)
* *Engineer's Tools* (1.0.6 --> 1.0.7)
* *Extreme sound muffler (Forge)* (1.0 --> 1.1)
* *Fast Leaf Decay* (20 --> 22)
* *Fx Control!* (1.0.1 --> 1.0.2)
* *In Control!* (4.0.2 --> 4.0.3)
* *JAOPCA* (3.2.0.8 --> 3.2.0.9)
* *Just Enough Items (JEI)* (6.0.0.2 --> 6.0.0.3)
* *Lollipop* (1.0.13 --> 1.0.14)
* *Mekanism* (9.9.17.409 --> 9.9.19.411)
* *Mekanism Generators* (9.9.17.409 --> 9.9.19.411)
* *Mekanism Tools* (9.9.17.409 --> 9.9.19.411)
* *mGui* (2.0.1 --> 2.1.1)
* *MoreVanillaLib* (1.0.2 --> 1.2.2)
* *Mystical Agriculture* (3.0.1 --> 3.0.2)
* *Natural Progression* (1.2.2 --> 1.3.0)
* *Pam's HarvestCraft 2 - Food Core* (1.0.2. --> 1.0.3)
* *Open Loader* (4.0.2 --> 4.0.3)
* *Patchouli* (1.2-28 --> 1.2-31)
* *Performant* (1.12 --> 2.06m)
